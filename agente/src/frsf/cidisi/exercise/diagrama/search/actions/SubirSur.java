...
public class SubirSur extends SearchAction {
    ...
    public SearchBasedAgentState execute(SearchBasedAgentState s) {
		...
		Nodo siguiente = ((EstadoAgente) s).getPosicion().getDestinos().get(Constantes.SUBIRSUR);
    ...
    public EnvironmentState execute(AgentState ast, EnvironmentState est) {
        ...
        //Obtenemos el nodo adyacente que se alcanza yendo al ESTE
		Nodo siguiente = ((EstadoAgente) ast).getPosicion().getDestinos().get(Constantes.SUBIRSUR);
