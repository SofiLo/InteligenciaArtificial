package frsf.cidisi.exercise.diagrama;
...
public class Inicializacion {
	...
	public static void inicializacion(){
		...
		nodoEscaleraTorre.agregarDestinos(Constantes.BAJAR, nodoIngresoTorre);
		nodoEscaleraTorre.agregarDestinos(Constantes.SUBIR, nodoPuertaEstadio);
		
		nodoPuertaPpal.agregarDestinos(Constantes.ESTE, nodoInicial);
		...
		// hayq ue ver bien este. porque los dos van al norte y no se deberia poder
	//	nodoPuertaPatioInterno.agregarDestinos(Constantes.NORTE, nodoEscaleraElectrica);
		
		nodoDptoElectrica.agregarDestinos(Constantes.SUR, nodoPuertaPatioInterno);
		
		//este tmb hay que ver como definimos bien el nivel.. porque tengo tres este
		nodoAscensor.agregarDestinos(Constantes.BAJAR, nodoPuertaPatioInterno);
		nodoAscensor.agregarDestinos(Constantes.SUBIR, nodoDptoCivil);
		nodoAscensor.agregarDestinos(Constantes.BAJAR, nodoDptoCivil);
		nodoAscensor.agregarDestinos(Constantes.SUBIR, nodoDptoIndustrial);
		nodoAscensor.agregarDestinos(Constantes.BAJAR, nodoDptoIndustrial);
		nodoAscensor.agregarDestinos(Constantes.SUBIR, nodoDptoISI);
		...
		nodoEscaleraPpal.agregarDestinos(Constantes.SUBIR, nodoBañosPrimerPiso);
		
		nodoBañosPlantaBaja.agregarDestinos(Constantes.SUR, nodoEscaleraPpal);
		
		nodoEscaleraBasicas.agregarDestinos(Constantes.NORTE, nodoAula1);
		nodoEscaleraBasicas.agregarDestinos(Constantes.NORTE, nodoAula1);
		nodoEscaleraBasicas.agregarDestinos(Constantes.SUR, nodoAula9);
		...
		//aca tambien
		nodoEscaleraChica.agregarDestinos(Constantes.ESTE, nodoDptoMecanica);
		nodoEscaleraChica.agregarDestinos(Constantes.ESTE, nodoDptoMecanica);
		nodoEscaleraChica.agregarDestinos(Constantes.OESTE, nodoDptoCivil);
		nodoEscaleraChica.agregarDestinos(Constantes.NORTE, nodoAula20);
		...
		//aca tambien
		nodoEscaleraElectrica.agregarDestinos(Constantes.SUR, nodoPuertaPatioInterno);
		nodoEscaleraElectrica.agregarDestinos(Constantes.ESTE, nodoDptoCivil);
		nodoEscaleraElectrica.agregarDestinos(Constantes.NORTE, nodoBaños2);
		nodoEscaleraElectrica.agregarDestinos(Constantes.SUR, nodoEscaleraISI);
		...
		nodoAula20.agregarDestinos(Constantes.ESTE, nodoEscaleraChica);
		...
		nodoAula22.agregarDestinos(Constantes.OESTE, nodoAula21);
		nodoAula22.agregarDestinos(Constantes.SUR, nodoEscaleraISI);
		
		//aca tambien
		nodoEscaleraISI.agregarDestinos(Constantes.ESTE, nodoEscaleraChica);
		nodoEscaleraISI.agregarDestinos(Constantes.NORTE, nodoEscaleraElectrica);
		nodoEscaleraISI.agregarDestinos(Constantes.NORTE, nodoAula22);
		...
		nodoLab1.agregarDestinos(Constantes.NORTE, nodoLab1);
		...
		nodoLab4.agregarDestinos(Constantes.OESTE, nodoLab4);
		
		nodoLab5.agregarDestinos(Constantes.ESTE, nodoLab4);
