...
public class Inicializacion {
	...
	public static void inicializacion(Grafo grafo){
		...
		grafo.agregarNodoAGrafo(nodoAlumnado);
		...
		grafo.agregarNodoAGrafo(nodoIngresoTorre);
		...
		grafo.agregarNodoAGrafo(nodoEscaleraTorre);
		...
		grafo.agregarNodoAGrafo(nodoPuertaPpal);
		...
		grafo.agregarNodoAGrafo(nodoAulaEstudio);
		...
		grafo.agregarNodoAGrafo(nodoDptoMecanica);
		...
		grafo.agregarNodoAGrafo(nodoPuertaPatioInterno);
		
		nodoDptoElectrica.agregarDestinos(Constantes.SUR, nodoPuertaPatioInterno);
		
		grafo.agregarNodoAGrafo(nodoDptoElectrica);
		
		nodoAscensor.agregarDestinos(Constantes.ESTE, nodoPuertaPatioInterno);
		nodoAscensor.agregarDestinos(Constantes.SUBIRESTE, nodoDptoCivil);//QUE PASA SI ESTOY EN EL 3RO Y QUIERO BAJAR A CIVIL
		nodoAscensor.agregarDestinos(Constantes.SUBIRNORTE, nodoDptoIndustrial);//LO MISMO
		nodoAscensor.agregarDestinos(Constantes.SUBIRESTE, nodoTICS);//ya tengo dos SUBIRESTE QUE HAGO
		
		grafo.agregarNodoAGrafo(nodoAscensor);
		...
		grafo.agregarNodoAGrafo(nodoEscaleraPpal);
		
		nodoBañosPlantaBaja.agregarDestinos(Constantes.SUR, nodoEscaleraPpal);
		
		grafo.agregarNodoAGrafo(nodoBañosPlantaBaja);
		...
		grafo.agregarNodoAGrafo(nodoBañosPrimerPiso);
		...
		grafo.agregarNodoAGrafo(nodoEscaleraChica);
		...
		grafo.agregarNodoAGrafo(nodoOficinaCivilGIMNI);
		...
		grafo.agregarNodoAGrafo(nodoDptoCivil);
		...
		grafo.agregarNodoAGrafo(nodoBaños2);
		...
		grafo.agregarNodoAGrafo(nodoEscaleraElectrica);
		...
		grafo.agregarNodoAGrafo(nodoEscaleraISI);
