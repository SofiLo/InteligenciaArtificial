...
public class Inicializacion {
	...
	//	nodoPuertaPatioInterno.agregarDestinos(Constantes.NORTE, nodoEscaleraElectrica);
		...
		nodoAscensor.agregarDestinos(Constantes.ESTE, nodoDptoCivil);
		nodoAscensor.agregarDestinos(Constantes.NORTE, nodoDptoIndustrial);
		nodoAscensor.agregarDestinos(Constantes.ESTE, nodoDptoISI);
		...
		nodoEscaleraPpal.agregarDestinos(Constantes.NORTE, nodoBañosPrimerPiso);
